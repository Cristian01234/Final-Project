...
public class ProductDtoValidator {
    ...
    public void validate(ProductDto productDto, BindingResult bindingResult) {
        ...
        try {
            ...
            if (priceAsInteger <= 0) {
                FieldError fieldError = new FieldError("productDto", "startBiddingPrice","This number most be positive");
                bindingResult.addError(fieldError);
            }
        } catch (NumberFormatException numberFormatException) {
            FieldError fieldError = new FieldError("productDto", "startBiddingPrice","This price most be positive");
            bindingResult.addError(fieldError);
